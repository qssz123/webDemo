<template>
  <div>
    <audio id="media" controls="" autoplay="autopaly">
      <source src="https://wj1.kumeiwp.com:812/wj/bl/2021/03/31/2692243fcc04ffb1aed6df82b3a97c39.mp3?t=1694090193&amp;key=d43241d07be6e87ec731" type="audio/mpeg">
    </audio>
  ...
  created() {
    var RENDERER = {
      ...
      setParameters: function() {
        const container = $('#jsi-cherry-container')
    ...
    CHERRY_BLOSSOM.prototype = {
      ...
      getAxis: function() {
        ...
        var x = this.renderer.width / 2 + this.x * rate
        var y = this.renderer.height / 2 - this.y * rate
...
.minbox li:nth-child(1) {
  background: url(https://ruanjiafeng2013.gitee.io/original-cherry-rain-3-d-album/img/6.png) no-repeat 0 0;
